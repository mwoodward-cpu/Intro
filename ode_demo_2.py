# -*- coding: utf-8 -*-
"""
Created on Sun Mar  8 20:16:20 2020
...
#Try to pick only two molecules to learn from. 
...
#print(mol_data)
true_y0 = mol_data[0,0:4095,1:5]  #the initial condition
t = torch.linspace(0, T, T+1)

#true_y = mol_data[:,:,1:5]


two_data=mol_data[:,0:1,4:5] #only chooses two molecules to learn dynamics
true_y = 
